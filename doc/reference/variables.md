...
```
$mageTriviaAnswerRejected
=> You must be following the channel to answer trivia questions
```
...
You do _not_ need to worry about avoiding calls to any of the [Mage Trivia built-in effects](/doc/reference/effects.md). For example, if you call the "Cancel Trivia Question" effect when there is no question in progress, it will be ignored. And if you call the "Create Trivia Question" effect when there is already a question in progress, it will be ignored.
