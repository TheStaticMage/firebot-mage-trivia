...
- [Gameplay Settings](#gameplay-settings)
    ...
    - [Limit Participation to Followers](#limit-participation-to-followers)
...
### Limit Participation to Followers

Check this box to limit participation to those users who are following your channel. When unchecked, anyone can play.

If this box is checked and a non-follower attempts to answer a question, the `Answer Rejected` event is fired. If you choose to trigger an effect, you can use the `$mageTriviaAnswerRejected` variable to report the reason. See [Events](/doc/reference/events.md).
